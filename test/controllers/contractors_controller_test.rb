...
class ContractorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contractor" do
    assert_difference('Contractor.count') do
      post contractors_url, params: { contractor: { cv: @contractor.cv, name: @contractor.name, rate: @contractor.rate } }
    end
  ...
  test "should update contractor" do
    patch contractor_url(@contractor), params: { contractor: { cv: @contractor.cv, name: @contractor.name, rate: @contractor.rate } }
